...
export const PROVIDER_ID = 'com.resonance.qobuz-tidal';
...
export const addon = defineAddon<QTConfig>({
  ...
  auth: {
    ...
    fields: [
      { key: 'quality', type: 'select', title: 'Qobuz Quality', options: ['HIRES', 'HIRES_96', 'CD', 'MP3'], defaultValue: 'HIRES' },
      { key: 'tidalQuality', type: 'select', title: 'Tidal Fallback Quality', options: ['HIGH', 'LOW'], defaultValue: 'HIGH' },
    ],
  },
